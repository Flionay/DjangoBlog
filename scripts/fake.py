...
if __name__ == '__main__':
    ...
    Post.objects.create(
        ...
        modified_time=fake.date_time_between(start_date='-1d', end_date="now",
                                             tzinfo=timezone.get_current_timezone())
    )
    ...
    for _ in range(100):
        ...
        created_time = fake.date_time_between(start_date='-8y', end_date="now",
                                              tzinfo=timezone.get_current_timezone())
        modified_time = fake.date_time_between(start_date='-3y', end_date="now",
                                               tzinfo=timezone.get_current_timezone())
